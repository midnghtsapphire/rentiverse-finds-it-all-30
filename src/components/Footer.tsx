        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-gray-400 hover:text-white">Fashion & Beauty</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Pets & Animals</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Furniture & Decor</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Heavy Equipment</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Events & Entertainment</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-400 hover:text-white">List Your Rental</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Trust & Safety</Link></li>
